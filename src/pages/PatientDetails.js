...
import { getUsers, getMeasurements, getAlerts, updateMeasurement, updateAlert, updateUser } from '../services/apiService';
...
<div className="patient-details-container">
    <header className="dashboard-header">
        <h1>Paciente: {patientProfile ? `${patientProfile.nombre} ${patientProfile.apellido}-${patientProfile.cedula} ` : cedula}</h1>
